...
class Attachment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'veilidchat'),
      createEmptyInstance: create)
    ..e<AttachmentKind>(1, _omitFieldNames ? '' : 'kind', $pb.PbFieldType.OE,
        defaultOrMaker: AttachmentKind.ATTACHMENT_KIND_UNSPECIFIED,
        valueOf: AttachmentKind.valueOf,
        enumValues: AttachmentKind.values)
    ..aOS(2, _omitFieldNames ? '' : 'mime')
    ..aOS(3, _omitFieldNames ? '' : 'name')
    ..aOM<$0.DataReference>(4, _omitFieldNames ? '' : 'content',
        subBuilder: $0.DataReference.create)
    ..aOM<$1.Signature>(5, _omitFieldNames ? '' : 'signature',
        subBuilder: $1.Signature.create)
...
class Message extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'veilidchat'),
      createEmptyInstance: create)
    ..aOM<$1.TypedKey>(1, _omitFieldNames ? '' : 'author',
        subBuilder: $1.TypedKey.create)
    ..a<$fixnum.Int64>(
        2, _omitFieldNames ? '' : 'timestamp', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOS(3, _omitFieldNames ? '' : 'text')
    ..aOM<$1.Signature>(4, _omitFieldNames ? '' : 'signature',
        subBuilder: $1.Signature.create)
    ..pc<Attachment>(
        5, _omitFieldNames ? '' : 'attachments', $pb.PbFieldType.PM,
...
class Conversation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$1.TypedKey>(3, _omitFieldNames ? '' : 'messages',
        subBuilder: $1.TypedKey.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  set identityMasterJson($core.String v) {
    $_setString(1, v);
  }
...
class Contact extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'veilidchat'),
      createEmptyInstance: create)
    ..aOM<Profile>(1, _omitFieldNames ? '' : 'editedProfile',
        subBuilder: Profile.create)
    ..aOM<Profile>(2, _omitFieldNames ? '' : 'remoteProfile',
        subBuilder: Profile.create)
    ..aOS(3, _omitFieldNames ? '' : 'identityMasterJson')
    ..aOM<$1.TypedKey>(4, _omitFieldNames ? '' : 'identityPublicKey',
        subBuilder: $1.TypedKey.create)
    ..aOM<$1.TypedKey>(5, _omitFieldNames ? '' : 'remoteConversationRecordKey',
        subBuilder: $1.TypedKey.create)
    ..aOM<$1.TypedKey>(6, _omitFieldNames ? '' : 'localConversationRecordKey',
        subBuilder: $1.TypedKey.create)
  ...
  @$pb.TagNumber(4)
  set identityPublicKey($1.TypedKey v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(5)
  set remoteConversationRecordKey($1.TypedKey v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(6)
  set localConversationRecordKey($1.TypedKey v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(7)
  set showAvailability($core.bool v) {
    $_setBool(6, v);
  }
...
class Profile extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<Availability>(
        ...
        defaultOrMaker: Availability.AVAILABILITY_UNSPECIFIED,
        valueOf: Availability.valueOf,
        enumValues: Availability.values)
    ..aOM<$1.TypedKey>(5, _omitFieldNames ? '' : 'avatar',
        subBuilder: $1.TypedKey.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  set availability(Availability v) {
    setField(4, v);
  }
...
class Chat extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<ChatType>(1, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE,
        defaultOrMaker: ChatType.CHAT_TYPE_UNSPECIFIED,
        valueOf: ChatType.valueOf,
        enumValues: ChatType.values)
    ..aOM<$1.TypedKey>(2, _omitFieldNames ? '' : 'remoteConversationKey',
        subBuilder: $1.TypedKey.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  set remoteConversationKey($1.TypedKey v) {
    setField(2, v);
  }
...
class Account extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(
        3, _omitFieldNames ? '' : 'autoAwayTimeoutSec', $pb.PbFieldType.OU3)
    ..aOM<$0.OwnedDHTRecordPointer>(4, _omitFieldNames ? '' : 'contactList',
        subBuilder: $0.OwnedDHTRecordPointer.create)
    ..aOM<$0.OwnedDHTRecordPointer>(
        5, _omitFieldNames ? '' : 'contactInvitationRecords',
        subBuilder: $0.OwnedDHTRecordPointer.create)
    ..aOM<$0.OwnedDHTRecordPointer>(6, _omitFieldNames ? '' : 'chatList',
        subBuilder: $0.OwnedDHTRecordPointer.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  set autoAwayTimeoutSec($core.int v) {
  ...
  @$pb.TagNumber(4)
  set contactList($0.OwnedDHTRecordPointer v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(5)
  set contactInvitationRecords($0.OwnedDHTRecordPointer v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(6)
  set chatList($0.OwnedDHTRecordPointer v) {
    setField(6, v);
  }
...
class ContactInvitation extends $pb.GeneratedMessage {
  ...
  factory ContactInvitation.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ContactInvitation.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ContactInvitation',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'veilidchat'),
      createEmptyInstance: create)
    ..aOM<$1.TypedKey>(1, _omitFieldNames ? '' : 'contactRequestInboxKey',
        subBuilder: $1.TypedKey.create)
    ..a<$core.List<$core.int>>(
        2, _omitFieldNames ? '' : 'writerSecret', $pb.PbFieldType.OY)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ContactInvitation copyWith(void Function(ContactInvitation) updates) =>
      super.copyWith((message) => updates(message as ContactInvitation))
  ...
  static $pb.PbList<ContactInvitation> createRepeated() =>
      $pb.PbList<ContactInvitation>();
  @$core.pragma('dart2js:noInline')
  static ContactInvitation getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ContactInvitation>(create);
  static ContactInvitation? _defaultInstance;

  @$pb.TagNumber(1)
  $1.TypedKey get contactRequestInboxKey => $_getN(0);
  @$pb.TagNumber(1)
  set contactRequestInboxKey($1.TypedKey v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set writerSecret($core.List<$core.int> v) {
    $_setBytes(1, v);
  }
...
class SignedContactInvitation extends $pb.GeneratedMessage {
  ...
  factory SignedContactInvitation.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SignedContactInvitation.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SignedContactInvitation',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'veilidchat'),
      createEmptyInstance: create)
    ..a<$core.List<$core.int>>(
        1, _omitFieldNames ? '' : 'contactInvitation', $pb.PbFieldType.OY)
    ..aOM<$1.Signature>(2, _omitFieldNames ? '' : 'identitySignature',
        subBuilder: $1.Signature.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SignedContactInvitation clone() =>
      SignedContactInvitation()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SignedContactInvitation copyWith(
          void Function(SignedContactInvitation) updates) =>
      super.copyWith((message) => updates(message as SignedContactInvitation))
          as SignedContactInvitation;
  ...
  static $pb.PbList<SignedContactInvitation> createRepeated() =>
      $pb.PbList<SignedContactInvitation>();
  @$core.pragma('dart2js:noInline')
  static SignedContactInvitation getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SignedContactInvitation>(create);
  static SignedContactInvitation? _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<$core.int> get contactInvitation => $_getN(0);
  @$pb.TagNumber(1)
  set contactInvitation($core.List<$core.int> v) {
    $_setBytes(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set identitySignature($1.Signature v) {
    setField(2, v);
  }
...
class ContactRequest extends $pb.GeneratedMessage {
  ...
  factory ContactRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ContactRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ContactRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'veilidchat'),
      createEmptyInstance: create)
    ..e<EncryptionKeyType>(
        1, _omitFieldNames ? '' : 'encryptionKeyType', $pb.PbFieldType.OE,
        defaultOrMaker: EncryptionKeyType.ENCRYPTION_KEY_TYPE_UNSPECIFIED,
        valueOf: EncryptionKeyType.valueOf,
        enumValues: EncryptionKeyType.values)
    ..a<$core.List<$core.int>>(
        2, _omitFieldNames ? '' : 'private', $pb.PbFieldType.OY)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ContactRequest copyWith(void Function(ContactRequest) updates) =>
      super.copyWith((message) => updates(message as ContactRequest))
          as ContactRequest;
  ...
  static $pb.PbList<ContactRequest> createRepeated() =>
      $pb.PbList<ContactRequest>();
  @$core.pragma('dart2js:noInline')
  static ContactRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ContactRequest>(create);
  static ContactRequest? _defaultInstance;

  @$pb.TagNumber(1)
  EncryptionKeyType get encryptionKeyType => $_getN(0);
  @$pb.TagNumber(1)
  set encryptionKeyType(EncryptionKeyType v) {
    setField(1, v);
  }
...
class ContactRequestPrivate extends $pb.GeneratedMessage {
  ...
  factory ContactRequestPrivate.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ContactRequestPrivate.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ContactRequestPrivate',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'veilidchat'),
      createEmptyInstance: create)
    ..aOM<$1.CryptoKey>(1, _omitFieldNames ? '' : 'writerKey',
        subBuilder: $1.CryptoKey.create)
    ..aOM<Profile>(2, _omitFieldNames ? '' : 'profile',
        subBuilder: Profile.create)
    ..aOM<$1.TypedKey>(3, _omitFieldNames ? '' : 'identityMasterRecordKey',
        subBuilder: $1.TypedKey.create)
    ..aOM<$1.TypedKey>(4, _omitFieldNames ? '' : 'chatRecordKey',
        subBuilder: $1.TypedKey.create)
    ..a<$fixnum.Int64>(
        5, _omitFieldNames ? '' : 'expiration', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ContactRequestPrivate clone() =>
      ContactRequestPrivate()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ContactRequestPrivate copyWith(
          void Function(ContactRequestPrivate) updates) =>
      super.copyWith((message) => updates(message as ContactRequestPrivate))
          as ContactRequestPrivate;
  ...
  static $pb.PbList<ContactRequestPrivate> createRepeated() =>
      $pb.PbList<ContactRequestPrivate>();
  @$core.pragma('dart2js:noInline')
  static ContactRequestPrivate getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ContactRequestPrivate>(create);
  static ContactRequestPrivate? _defaultInstance;

  @$pb.TagNumber(1)
  $1.CryptoKey get writerKey => $_getN(0);
  @$pb.TagNumber(1)
  set writerKey($1.CryptoKey v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(3)
  set identityMasterRecordKey($1.TypedKey v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(4)
  set chatRecordKey($1.TypedKey v) {
    setField(4, v);
  }
...
class ContactResponse extends $pb.GeneratedMessage {
  ...
  factory ContactResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ContactResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ContactResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'veilidchat'),
      createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'accept')
    ..aOM<$1.TypedKey>(2, _omitFieldNames ? '' : 'identityMasterRecordKey',
        subBuilder: $1.TypedKey.create)
    ..aOM<$1.TypedKey>(3, _omitFieldNames ? '' : 'remoteConversationRecordKey',
        subBuilder: $1.TypedKey.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ContactResponse copyWith(void Function(ContactResponse) updates) =>
      super.copyWith((message) => updates(message as ContactResponse))
          as ContactResponse;
  ...
  static $pb.PbList<ContactResponse> createRepeated() =>
      $pb.PbList<ContactResponse>();
  @$core.pragma('dart2js:noInline')
  static ContactResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ContactResponse>(create);
...
class SignedContactResponse extends $pb.GeneratedMessage {
  ...
  factory SignedContactResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SignedContactResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'SignedContactResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'veilidchat'),
      createEmptyInstance: create)
    ..a<$core.List<$core.int>>(
        1, _omitFieldNames ? '' : 'contactResponse', $pb.PbFieldType.OY)
    ..aOM<$1.Signature>(2, _omitFieldNames ? '' : 'identitySignature',
        subBuilder: $1.Signature.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  SignedContactResponse clone() =>
      SignedContactResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SignedContactResponse copyWith(
          void Function(SignedContactResponse) updates) =>
      super.copyWith((message) => updates(message as SignedContactResponse))
  ...
  static $pb.PbList<SignedContactResponse> createRepeated() =>
      $pb.PbList<SignedContactResponse>();
  @$core.pragma('dart2js:noInline')
  static SignedContactResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SignedContactResponse>(create);
  static SignedContactResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<$core.int> get contactResponse => $_getN(0);
  @$pb.TagNumber(1)
  set contactResponse($core.List<$core.int> v) {
    $_setBytes(0, v);
  }
...
class ContactInvitationRecord extends $pb.GeneratedMessage {
  ...
  factory ContactInvitationRecord.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ContactInvitationRecord.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ContactInvitationRecord',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'veilidchat'),
      createEmptyInstance: create)
    ..aOM<$0.OwnedDHTRecordPointer>(
        1, _omitFieldNames ? '' : 'contactRequestInbox',
        subBuilder: $0.OwnedDHTRecordPointer.create)
    ..aOM<$1.CryptoKey>(2, _omitFieldNames ? '' : 'writerKey',
        subBuilder: $1.CryptoKey.create)
    ..aOM<$1.CryptoKey>(3, _omitFieldNames ? '' : 'writerSecret',
        subBuilder: $1.CryptoKey.create)
    ..aOM<$1.TypedKey>(4, _omitFieldNames ? '' : 'localConversationRecordKey',
        subBuilder: $1.TypedKey.create)
    ..a<$fixnum.Int64>(
        5, _omitFieldNames ? '' : 'expiration', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.List<$core.int>>(
        6, _omitFieldNames ? '' : 'invitation', $pb.PbFieldType.OY)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ContactInvitationRecord clone() =>
      ContactInvitationRecord()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ContactInvitationRecord copyWith(
          void Function(ContactInvitationRecord) updates) =>
      super.copyWith((message) => updates(message as ContactInvitationRecord))
  ...
  static $pb.PbList<ContactInvitationRecord> createRepeated() =>
      $pb.PbList<ContactInvitationRecord>();
  @$core.pragma('dart2js:noInline')
  static ContactInvitationRecord getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ContactInvitationRecord>(create);
  static ContactInvitationRecord? _defaultInstance;

  @$pb.TagNumber(1)
  $0.OwnedDHTRecordPointer get contactRequestInbox => $_getN(0);
  @$pb.TagNumber(1)
  set contactRequestInbox($0.OwnedDHTRecordPointer v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(3)
  set writerSecret($1.CryptoKey v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(6)
  set invitation($core.List<$core.int> v) {
    $_setBytes(5, v);
  }
